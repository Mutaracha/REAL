...
const Entry TABLE[] = {
    ...
    { Str::ButtonReinitialize, "Reinitialize", "Инициализация" },
    ...
    { Str::TrayReinitialize, "Reinitialize now", "Инициализация" },
    ...
    { Str::CfgCommentLanguage, "Service field: the language of the comments in this file. Changed automatically with application.language.",
                               "Служебное поле: язык комментариев в этом файле. Меняется автоматически вместе с application.language." },
